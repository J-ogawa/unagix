...
return cljs.core.reduce.call(null,(function (result,p__42725){
...
var vec__42728 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__42728,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__42728,(1),null);
var ab = cljs.core.nth.call(null,vec__42728,(2),null);
...
return cljs.core.vec.call(null,cljs.core.map.call(null,clojure.data.vectorize,clojure.data.diff_associative.call(null,((cljs.core.vector_QMARK_.call(null,a))?a:cljs.core.vec.call(null,a)),((cljs.core.vector_QMARK_.call(null,b))?b:cljs.core.vec.call(null,b)),cljs.core.range.call(null,(function (){var x__4234__auto__ = cljs.core.count.call(null,a);
var y__4235__auto__ = cljs.core.count.call(null,b);
return ((x__4234__auto__ > y__4235__auto__) ? x__4234__auto__ : y__4235__auto__);
})()))));
});
...
clojure.data.EqualityPartition = (function (){var obj42730 = {};
return obj42730;
})();
...
return (function (){var or__3917__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4561__auto__)]);
if(or__3917__auto__){
return or__3917__auto__;
} else {
var or__3917__auto____$1 = (clojure.data.equality_partition["_"]);
...
clojure.data.Diff = (function (){var obj42732 = {};
return obj42732;
})();

clojure.data.diff_similar = (function diff_similar(a,b){
if((function (){var and__3905__auto__ = a;
if(and__3905__auto__){
...
var x__4561__auto__ = (((a == null))?null:a);
return (function (){var or__3917__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4561__auto__)]);
if(or__3917__auto__){
return or__3917__auto__;
} else {
var or__3917__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__3917__auto____$1){
return or__3917__auto____$1;
} else {
...
if((function (){var G__42733 = x;
if(G__42733){
var bit__4598__auto__ = (G__42733.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__4598__auto__) || (G__42733.cljs$core$IMap$)){
return true;
} else {
if((!G__42733.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__42733);
} else {
return false;
}
}
...
if((function (){var G__42734 = x;
if(G__42734){
var bit__4598__auto__ = (G__42734.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__4598__auto__) || (G__42734.cljs$core$ISet$)){
return true;
} else {
if((!G__42734.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__42734);
} else {
return false;
}
}
...
if((function (){var G__42735 = x;
if(G__42735){
var bit__4598__auto__ = (G__42735.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__4598__auto__) || (G__42735.cljs$core$ISequential$)){
return true;
} else {
if((!G__42735.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__42735);
} else {
return false;
}
}
...
return (function (){var G__42736 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__42736) {
case "map":
