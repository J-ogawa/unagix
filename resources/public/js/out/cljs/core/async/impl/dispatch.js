...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15159 = (0);while(true){
var m_15160 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15160 == null))
{} else
{m_15160.call(null);
if((count_15159 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15161 = (count_15159 + (1));
count_15159 = G__15161;
continue;
}
} else
{}
