...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_15079 = (0);while(true){
if((i_15079 < arr.length))
{(arr[i_15079] = null);
{
var G__15080 = (i_15079 + (1));
i_15079 = G__15080;
continue;
}
} else
...
{var i_15086 = (self__.level + (1));while(true){
if((i_15086 <= (new_level + (1))))
{(update[i_15086] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_15088 = (0);while(true){
if((i_15088 <= self__.level))
{var links_15089 = (update[i_15088]).forward;if(((links_15089[i_15088]) === x__$1))
{(links_15089[i_15088] = (x__$1.forward[i_15088]));
{
