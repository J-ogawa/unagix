...
{return cljs.core.reduce.call(null,(function (result,p__12378){var vec__12379 = p__12378;var k = cljs.core.nth.call(null,vec__12379,(0),null);var v = cljs.core.nth.call(null,vec__12379,(1),null);return cljs.core.assoc.call(null,result,k,v);
...
*/
clojure.data.diff_associative_key = (function diff_associative_key(a,b,k){var va = cljs.core.get.call(null,a,k);var vb = cljs.core.get.call(null,b,k);var vec__12381 = clojure.data.diff.call(null,va,vb);var a_STAR_ = cljs.core.nth.call(null,vec__12381,(0),null);var b_STAR_ = cljs.core.nth.call(null,vec__12381,(1),null);var ab = cljs.core.nth.call(null,vec__12381,(2),null);var in_a = cljs.core.contains_QMARK_.call(null,a,k);var in_b = cljs.core.contains_QMARK_.call(null,b,k);var same = (in_a) && (in_b) && ((!((ab == null))) || (((va == null)) && ((vb == null))));return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((in_a) && ((!((a_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,a_STAR_], true, false):null),(((in_b) && ((!((b_STAR_ == null))) || (!(same))))?new cljs.core.PersistentArrayMap.fromArray([k,b_STAR_], true, false):null),((same)?new cljs.core.PersistentArrayMap.fromArray([k,ab], true, false):null)], null);
});
/**
...
clojure.data.EqualityPartition = (function (){var obj12383 = {};return obj12383;
})();
clojure.data.equality_partition = (function equality_partition(x){if((function (){var and__3587__auto__ = x;if(and__3587__auto__)
...
{var x__4236__auto__ = (((x == null))?null:x);return (function (){var or__3599__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4236__auto__)]);if(or__3599__auto__)
{return or__3599__auto__;
} else
{var or__3599__auto____$1 = (clojure.data.equality_partition["_"]);if(or__3599__auto____$1)
...
clojure.data.Diff = (function (){var obj12385 = {};return obj12385;
})();
clojure.data.diff_similar = (function diff_similar(a,b){if((function (){var and__3587__auto__ = a;if(and__3587__auto__)
...
{var x__4236__auto__ = (((a == null))?null:a);return (function (){var or__3599__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4236__auto__)]);if(or__3599__auto__)
{return or__3599__auto__;
} else
{var or__3599__auto____$1 = (clojure.data.diff_similar["_"]);if(or__3599__auto____$1)
{return or__3599__auto____$1;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__12386 = x;if(G__12386)
{var bit__4263__auto__ = (G__12386.cljs$lang$protocol_mask$partition0$ & (1024));if((bit__4263__auto__) || (G__12386.cljs$core$IMap$))
{return true;
} else
{if((!G__12386.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__12386);
} else
{return false;
}
}
...
{if((function (){var G__12387 = x;if(G__12387)
{var bit__4263__auto__ = (G__12387.cljs$lang$protocol_mask$partition0$ & (4096));if((bit__4263__auto__) || (G__12387.cljs$core$ISet$))
{return true;
} else
...
{if((function (){var G__12388 = x;if(G__12388)
{var bit__4263__auto__ = (G__12388.cljs$lang$protocol_mask$partition0$ & (16777216));if((bit__4263__auto__) || (G__12388.cljs$core$ISequential$))
{return true;
} else
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__12389 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);switch (G__12389) {
case "map":
